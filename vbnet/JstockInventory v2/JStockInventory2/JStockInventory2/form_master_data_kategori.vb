...
Imports System.Math
Public Class form_master_data_kategori
    ...
    Public Sub prepare_data_pelengkap()
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            Me.total_data = data_obj.get_total_rows("master_kategori_produk")
    ...
    Public Sub selected_view(e As DataGridViewCellEventArgs)
        ...
        Try
            If (e.RowIndex >= 0) And DGView.CurrentCell.Value <> Nothing Then
                ...
                text_nama_kategori.Text = row.Cells("nama_kategori").Value.ToString
    ...
    Private Sub form_master_data_kategori_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            basic_op.hide_id(label_id, text_id)
            form_master_data_kategori_add.added_data = 0
            Me.saved_data = 0
            Me.page = 1
    ...
    Public Sub LoadData(ByVal hal As Integer)
        Try
            ...
            sql = "SELECT id,nama_kategori,keterangan,jumlah_total  FROM master_kategori_produk  order by `id` desc limit " + pg_str + ",10"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        form_master_data_kategori_add.Show()
        basic_op.setfokus(form_master_data_kategori_add)
    End Sub

    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            If form_master_data_kategori_add.added_data = 1 Or Me.saved_data = 1 Then
                Call prepare_data_pelengkap()
                Call LoadData(page)
                Me.saved_data = 0
                form_master_data_kategori_add.added_data = 0
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            If Len(text_nama_kategori.Text) < 1 Then
                MsgBox("nama kategori harus diisi")
            Else
                Dim ret = 0
                Dim nama_kategori = text_nama_kategori.Text
                Dim keterangan = text_keterangan.Text
                Dim jumlah_total = text_jumlah_total.Text.Replace(",", "")
                Dim id = text_id.Text
                Dim sql = "update `master_kategori_produk` set `nama_kategori` = '" + nama_kategori + "', `keterangan` = '" + keterangan + "', `jumlah_total` = '" + jumlah_total + "' where `id` like '" + id + "'"
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            Dim hapus = basic_op.konfirmasi_hapus("Apakah data kategori produk akan dihapus ?", "Hapus Data Kategori Produk")
            If hapus = 1 Then
                Dim id = text_id.Text
                Dim res = 0
                res = data_obj.mysql_del("master_kategori_produk", id)
                If res = 0 Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            If (Len(textcari_nama_kategori.Text) > 1) Then
                datatable_mysql = data_obj.load_data_pencarian(textcari_nama_kategori.Text, "nama_kategori", "master_kategori_produk")
                DGView.DataSource = datatable_mysql
                DGView.AlternatingRowsDefaultCellStyle.BackColor = Color.AliceBlue
                Call format_dgview()
                Dim i As Integer
    ...
    Private Overloads Sub textcari_nama_kategori_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles textcari_nama_kategori.KeyDown
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            If Len(textcari_nama_kategori.Text) > 1 Then
    ...
    Private Sub tombol_csv_Click(sender As Object, e As EventArgs) Handles tombol_csv.Click
        ...
        form_csv.nama_tabel = "master_kategori_produk"
        form_csv.Show()
    ...
    Private Sub tombol_delete_all_Click(sender As Object, e As EventArgs) Handles tombol_delete_all.Click
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            Dim hapus = basic_op.konfirmasi_hapus("Apakah Anda yakin untuk menghapus seluruh data kategori produk ?", "Hapus Data Seluruh Kategori Produk")
            If hapus = 1 Then
                form_delete_all.table_name = "master_kategori_produk"
