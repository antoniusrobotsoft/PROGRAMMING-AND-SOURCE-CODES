...
public class activity_foto_recruiter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foto_recruiter);
        try {
            listen_userclick();
            String url = "";
            //ScrollView mybaby = (ScrollView) findViewById(R.id.scrollmebaby);
            WebView webView = (WebView) findViewById(R.id.recruiter_foto);
            ...
            */
            ...
            url = getResources().getString(R.string.register_upload_recruiter_foto);
            webView.loadUrl(url);
           // mybaby.scrollTo(0,0);
        }
        catch (Exception e) {
            fso._do_log_debug(e, "onCreate foto recruiter");
        }
    }
