...
public class activity_link_player extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_link_player);
        try {
            listen_userclick();
            String url = "";
            //ScrollView mybaby = (ScrollView) findViewById(R.id.scrollmebaby);
            WebView webView = (WebView) findViewById(R.id.player_link);
            ...
            */
            ...
            url = getResources().getString(R.string.register_upload_player_link);
            webView.loadUrl(url);
            //mybaby.scrollTo(0,0);
        }
        catch (Exception e) {
            fso._do_log_debug(e, "onCreate link player");
        }
